...
function injectRadialMenu() {
    ...
    const allPages = [
        ...
        { href: '/desktop', icon: '▣', key: 'common.nav_desktop' },
...
function initShared() {
    ...
    if (typeof initTheme === 'function') { try { initTheme(); } catch (e) { console.error('[AuraGo] initTheme failed:', e); } }
    if (typeof ensure8BitChatThemeOption === 'function') { try { ensure8BitChatThemeOption(); } catch (e) { console.error('[AuraGo] ensure8BitChatThemeOption failed:', e); } }
    ...
    if (typeof initThemeToggle === 'function') { try { initThemeToggle(); } catch (e) { console.error('[AuraGo] initThemeToggle failed:', e); } }
