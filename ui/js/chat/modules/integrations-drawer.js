        ...
        listEl.innerHTML = webhosts.map(item => {
            ...
            return `
                <div class="integration-item" data-integration-id="${escapeAttr(item.id)}">
                    <div class="integration-icon">${window.chatUiIconMarkup ? window.chatUiIconMarkup('web') : ''}</div>
                    <div class="integration-main">
                        ...
                        <div class="integration-meta">
                            ...
                            <span class="integration-url">${escapeHtml(item.url || '')}</span>
                        </div>
                    </div>
                    <button type="button" class="integration-open" data-url="${escapeAttr(item.url || '')}">${escapeHtml(t('chat.integrations_open'))}</button>
                </div>`;
        }).join('');
