...
`)+`
`+p);let R=S+m+o,b=S+p+a,w=td(i,i.VERTEX_SHADER,R),y=td(i,i.FRAGMENT_SHADER,b);i.attachShader(M,w),i.attachShader(M,y),t.index0AttributeName!==void 0?i.bindAttribLocation(M,0,t.index0AttributeName):t.hasPositionAttribute===!0&&i.bindAttribLocation(M,0,"position"),i.linkProgram(M);function C(P){if(s.debug.checkShaderErrors){let L=i.getProgramInfoLog(M)||"",H=i.getShaderInfoLog(w)||"",F=i.getShaderInfoLog(y)||"",U=L.trim(),V=H.trim(),O=F.trim(),Y=!0,J=!0;if(i.getProgramParameter(M,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,M,w,y);else{let j=id(i,w,"vertex"),me=id(i,y,"fragment");Ze("WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(M,i.VALIDATE_STATUS)+`
