(function () {
    ...
    async function launch(state) {
        ...
        const body = {
            ...
            allow_internet: capabilities(state).internet === true && state.host.querySelector('[data-role="network"]')?.value === 'internet'
        };
