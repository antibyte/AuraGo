(function () {
    ...
    const WIDGET_AUTO_SIZE_PADDING = 6, WIDGET_FRAME_SCROLLBAR_BUFFER = 24;
    ...
    function resizeWidgetToContent(widgetId, payload) { const id = String(widgetId || ''); if (!id) return; const card = document.querySelector(`.vd-widget[data-widget-id="${cssSel(id)}"]`); if (card && card.dataset.widgetAutoSize === 'true') applyWidgetAutoSize(card, payload || {}); }
