...
func TestVirtualComputersControlCenterTranslations(t *testing.T) {
	...
	keys := []string{
		...
		"desktop.virtual_computers_network",
		"desktop.virtual_computers_network_disabled",
		"desktop.virtual_computers_network_internet",
		"desktop.virtual_computers_network_offline",
