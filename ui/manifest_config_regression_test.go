...
func TestManifestConfigModuleControls(t *testing.T) {
	...
	for _, marker := range []string{
		...
		"config.manifest.routing_title",
		"manifest.routing.enabled",
		"manifest.routing.specificity_mode",
		"manifest.routing.specificity",
		"manifest.routing.headers",
		"manifestRoutingHeaderRows",
		"manifestRoutingAddHeader",
		"manifestRoutingRemoveHeader",
		"manifestPayload",
