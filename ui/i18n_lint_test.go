...
func TestTranslations_WebUIReleaseFixKeysAreTranslated(t *testing.T) {
	...
	cases := []struct {
		...
		{relPath: filepath.Join("lang", "config", "prompts"), key: "config.personality.helper_required"},
		...
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.section.github.label"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_title"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_enabled_label"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_specificity_mode_label"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_specificity_label"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_headers_label"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_add_header"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_remove_header"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_note"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_mode_off"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_mode_fixed"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_mode_auto"},
		{relPath: filepath.Join("lang", "config", "sections"), key: "config.manifest.routing_specificity_none"},
