...
func TestDesktopAndFileManagerShareCutCopyPaste(t *testing.T) {
	...
	for _, marker := range []string{
		...
		"{ label: t('desktop.fm.cut'), action: 'cut'",
		"{ label: t('desktop.fm.copy'), action: 'copy'",
		"{ label: t('desktop.fm.paste'), action: 'paste'",
...
func TestDesktopFilesCanBeAddedOrAskedInAgentChat(t *testing.T) {
	...
	for _, marker := range []string{
		...
		"{ label: t('desktop.fm.add_to_chat'), action: 'add-to-chat'",
		"{ label: t('desktop.fm.ask_agent'), action: 'ask-agent'",
		"{ label: t('desktop.fm.add_to_chat'), icon: 'chat'",
		"{ label: t('desktop.fm.ask_agent'), icon: 'agent'",
