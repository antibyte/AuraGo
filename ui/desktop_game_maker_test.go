...
func TestGameMakerStudioTranslationsCoverEveryDesktopLocale(t *testing.T) {
	...
	required := []string{
		...
		"game_maker.visual_review",
		"game_maker.visual_capturing",
		"game_maker.visual_analyzing",
		"game_maker.visual_repairing",
		"game_maker.visual_capture_unavailable",
		"game_maker.visual_no_vision_route",
		"game_maker.visual_public_url_required",
		"game_maker.visual_analysis_failed",
		"game_maker.visual_invalid_response",
