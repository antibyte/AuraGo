...
func TestDesktopPapirusAssetsAreEmbedded(t *testing.T) {
	...
	for _, key := range []string{
		...
		"agent-chat", "calculator", "camera", "chat", "cloud", "code", "code-studio", "commandcode", "css", "database", "desktop",
		...
		"python", "radio", "redo", "server", "settings", "spreadsheet", "terminal", "text", "tools",
		"pixel", "trash", "trash-empty", "trash-full", "undo", "video", "weather", "workflow", "writer", "xml", "yaml", "zipper", "zoom-in", "zoom-out", "zoom-reset",
		...
		"search", "software-store", "sort", "stop", "upload", "x",
	} {
