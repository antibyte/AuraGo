...
func TestDesktopOpenSCADAppMarkers(t *testing.T) {
	...
	for _, want := range []string{
		...
		"data-oscad-apply-source",
		"data-oscad-discard-source",
		"data-oscad-transcript",
		"revealLine",
		"pendingAgentSource",
		"agentHistory",
		"renderIssues",
...
func TestDesktopOpenSCADDefinesModule(t *testing.T) {
	...
	for _, want := range []string{
		...
		"data-oscad-reset",
		"data-oscad-remove",
		"data-oscad-add-define",
		"desktop.openscad.add_define",
		"desktop.openscad.remove_define",
		"desktop.openscad.reset_defaults",
	} {
...
func TestDesktopOpenSCADTranslations(t *testing.T) {
	...
	keys := []string{
		...
		"desktop.openscad.add_define",
		"desktop.openscad.agent_history",
		"desktop.openscad.apply_changes",
		"desktop.openscad.collapsed_agent",
		"desktop.openscad.collapsed_parameters",
		"desktop.openscad.discard_changes",
		"desktop.openscad.draft_saved",
		"desktop.openscad.export_2d",
		"desktop.openscad.export_3d",
		"desktop.openscad.issues",
		"desktop.openscad.mode_preview_hint",
		"desktop.openscad.no_issues",
		"desktop.openscad.pending_source",
		"desktop.openscad.remove_define",
		"desktop.openscad.reset_defaults",
		"desktop.openscad.shortcuts",
		"desktop.openscad.viewport_auto_rotate",
