...
// Supported chat themes: 'dark' (standard), 'light', 'retro-crt', 'cyberwar', 'lollipop', 'dark-sun'
const CHAT_THEMES = ['dark', 'light', 'retro-crt', 'cyberwar', 'lollipop', 'dark-sun'];
 ...
 * dark/retro-crt/cyberwar/dark-sun → github-dark, light/lollipop → github with CSS enhancement layers
 */
