...
function renderMeshCoreSection(section) {
    ...
    document.getElementById('content').innerHTML = form.renderSpec({ label: section.label, desc: section.desc,
        ...
        groups: [
            ...
            { title: tr('additional_prompt'), fields: [form.textarea({ path: 'meshcore.additional_prompt', label: tr('additional_prompt'), help: tr('additional_prompt_help'), value: data.additional_prompt || '', rows: 5 }).replace('<textarea ', '<textarea maxlength="2000" ')] },
