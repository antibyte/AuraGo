...
h.runtime.actionActive = true; h.runtime.state = 'executing';
h.runtime.adapter = { getOutputLevel: () => 0 };
h.runtime.getProgressOutputLevel = () => 0.5;
h.step(80); h.step(50);
assert.ok(inputs.mouthOpen.value > 0.2, 'server synthesized progress audio must animate the Persona mouth');
h.runtime.getProgressOutputLevel = () => 0;
h.step(80);
h.runtime.actionActive = false;
