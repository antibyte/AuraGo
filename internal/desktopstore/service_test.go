...
func TestDefaultCatalogContainsInitialApps(t *testing.T) {
	...
	expected := map[string]struct {
		...
		"n8n":                 {image: "ghcr.io/n8n-io/n8n:latest", port: 5678, icon: "n8n"},
		"node-red":            {image: "ghcr.io/node-red/node-red:latest", port: 1880, icon: "node-red"},
		"open-webui":          {image: "ghcr.io/open-webui/open-webui:main", port: 8080, icon: "open-webui"},
		...
		"olivetin":            {image: "ghcr.io/olivetin/olivetin:latest", port: 1337, icon: "olivetin"},
		...
		"romm":                {image: "ghcr.io/rommapp/romm:latest", port: 8080, icon: "romm"},
		"beszel":              {image: "ghcr.io/henrygd/beszel/beszel:latest", port: 8090, icon: "monitor"},
		"dozzle":              {image: "ghcr.io/amir20/dozzle:latest", port: 8080, icon: "dozzle"},
		"code-server":         {image: "ghcr.io/linuxserver/code-server:latest", port: 8443, icon: "code"},
		"termix":              {image: "ghcr.io/lukegus/termix:latest", port: 8080, icon: "termix"},
