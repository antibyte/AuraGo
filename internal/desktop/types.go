...
func BuiltinApps() []AppManifest {
	apps := []AppManifest{
		...
		{ID: "nasscad", Name: "NASSCAD", Version: "4.2.7", Icon: "nasscad", Entry: "builtin://nasscad", Runtime: BuiltinRuntime, Description: "Browser-based 3D parametric CAD — model parts, run booleans, and export STL, OBJ, or 3MF.", Metadata: map[string]string{"open_maximized": "true"}},
