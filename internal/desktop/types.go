...
func BuiltinApps() []AppManifest {
	apps := []AppManifest{
		...
		{ID: "mission-control", Name: "Mission Control", Version: "1.0.0", Icon: "run", Entry: "builtin://mission-control", Runtime: BuiltinRuntime, Description: "Create, plan, and manage agent missions with triggers and schedules.", Permissions: []string{"notifications"}},
