...
func DesktopSettingDefinitions() []SettingDefinition {
	return []SettingDefinition{
		...
		{Key: "sound.enabled", Default: "false", Values: []string{"true", "false"}},
		{Key: "sound.theme", Default: "crystal", Values: []string{"crystal", "wood", "analog", "workshop", "water"}},
		{Key: "sound.volume", Default: "0.6"},
		{Key: "sound.windows", Default: "true", Values: []string{"true", "false"}},
		{Key: "sound.notifications", Default: "true", Values: []string{"true", "false"}},
		{Key: "sound.navigation", Default: "true", Values: []string{"true", "false"}},
		{Key: "sound.files", Default: "true", Values: []string{"true", "false"}},
		{Key: "windows.default_size", Default: "balanced", Values: []string{"compact", "balanced", "large"}},
		{Key: "windows.restore_session", Default: "true", Values: []string{"true", "false"}},
		{Key: "appearance.dock_pins", Default: `["files","writer","code-studio","settings","calendar"]`},
		{Key: "session.windows", Default: ""},
		{Key: "files.default_apps", Default: "{}"},
		...
		{Key: "pet.scale", Default: "0.5"},
		{Key: "pet.position_x", Default: "-1"},
		{Key: "pet.position_y", Default: "-1"},
...
func BuiltinApps() []AppManifest {
	apps := []AppManifest{
		...
		{ID: "rtl-sdr", Name: "RTL-SDR", Version: "1.0.0", Icon: "radio", Entry: "builtin://rtl-sdr", Runtime: BuiltinRuntime, Description: "Live analog and DAB+ radio, scheduled recordings and speech transcripts."},
