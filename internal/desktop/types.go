...
func BuiltinApps() []AppManifest {
	apps := []AppManifest{
		...
		{ID: "virtual-computers", Name: "Virtual Computers", Version: "1.0.0", Icon: "terminal", Entry: "builtin://virtual-computers", Runtime: BuiltinRuntime, Description: "Launch and inspect short-lived microVM computers through AuraGo.", Permissions: []string{"notifications"}},
