...
// ─── V9A: Archive / Backup Filters ──────────────────────────────────────────

// compressTar handles tar create, list, and extract outputs.
// Strategy: group file paths by directory, keep summary line, deduplicate progress.
