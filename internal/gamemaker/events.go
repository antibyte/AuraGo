...
func (s *Service) EmitAgentEvent(ctx context.Context, projectID, jobID, eventType string, payload map[string]any) error {
	switch eventType {
	case "text_delta", "skill_activation", "file_changed", "asset_changed", "diagnostic", "phase", "token_usage", "prompt_usage", "tool_call", "tool_result", "model_progress", "visual_progress", "visual_result":
	default:
