...
class Shooter extends GameScene {
  ...
  setup() {
    this.player = this.body(480, 450, 30, 36, 0x5eead4);
  ...
  spawn() {
    const enemy = this.body(this.player.x, 100, 32, 32, 0xfb7185);
  ...
  action() {
    ...
    const shot = this.body(this.player.x, this.player.y - 24, 6, 18, 0xfacc15);
