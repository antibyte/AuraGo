...
class Blocks extends GameScene {
  ...
  setup() {
    this.lives=3;this.player=this.body(480,490,120,18,0x5eead4);this.player.body.setImmovable(true);
    this.ball=this.body(480,465,16,16,0xfacc15);this.ball.body.setBounce(1);
    this.blocks=this.physics.add.staticGroup();
    for(let row=0;row<3;row++)for(let col=0;col<8;col++){const b=this.body(130+col*100,110+row*34,90,24,0xa78bfa,true);this.blocks.add(b);}
