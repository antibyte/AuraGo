		...
		tools = append(tools, tool("huggingface",
			...
			schema(map[string]interface{}{
				"operation": operationProperty("Hugging Face operation.", []string{
					...
					"jobs_list", "job_get", "job_logs", "job_run_script", "job_run_container", "job_cancel",
				...
				"script":          prop("string", "UV/Python script content for a Job."),
				"image":           prop("string", "Container image for a container Job."),
				"command":         prop("string", "Command for a container Job."),
				...
				"args":            map[string]interface{}{"type": "object", "description": "Structured arguments for a Job.", "additionalProperties": true},
			}, "operation"),
		))
	}
	if ff.MQTTEnabled {
