	...
	result := func() string {
		...
		case "browser_automation":
			...
			return "Tool Output: " + tools.ExecuteBrowserAutomation(ctx, cfg, tools.BrowserAutomationRequest{
				...
				CloakHumanize:        req.CloakHumanize,
				CloakProxy:           req.CloakProxy,
				CloakFingerprintSeed: req.CloakFingerprintSeed,
			}, logger)
		...
		case "send_telegram", "send_agodesk_chat", "send_notification", "notification_center", "send_push_notification", "web_push", "send_image", "send_audio", "send_video", "send_youtube_video", "send_document":
