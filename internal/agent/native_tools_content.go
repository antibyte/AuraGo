		...
		tools = append(tools, tool("yepapi_youtube",
			...
			schema(map[string]interface{}{
				"operation": map[string]interface{}{
					...
					"enum":        []string{"search", "video", "video_info", "metadata", "transcript", "subtitles", "comments", "channel", "channel_videos", "channel_shorts", "channel_live", "channel_playlists", "channel_channels", "channel_search", "playlist", "playlist_info", "trending", "related", "screenshot", "shorts", "shorts_info", "suggest", "hashtag", "home", "hype", "resolve"},
				},
	...
	if ff.YepAPIInstagramEnabled {
		tools = append(tools, tool("yepapi_instagram",
			...
			schema(map[string]interface{}{
				...
				"username_or_url": prop("string", "Instagram username or profile URL alias; AuraGo sends this value to YepAPI as username"),
