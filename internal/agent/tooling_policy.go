...
func buildToolFlagsFromConfig(cfg *config.Config) ToolFeatureFlags {
	...
	return ToolFeatureFlags{
		...
		SIPPhoneEnabled:            cfg.SIP.Enabled,
		SIPPhoneDialEnabled:        cfg.SIP.Enabled && !cfg.SIP.ReadOnly && cfg.SIP.Permissions.OriginateOutbound,
		SIPPhoneAnswerEnabled:      cfg.SIP.Enabled && !cfg.SIP.ReadOnly && cfg.SIP.Permissions.AnswerInbound,
		SIPPhoneDTMFEnabled:        cfg.SIP.Enabled && !cfg.SIP.ReadOnly && cfg.SIP.Permissions.SendDTMF,
		SIPPhoneHangupEnabled:      cfg.SIP.Enabled && !cfg.SIP.ReadOnly && cfg.SIP.Permissions.AgentHangup,
		...
		CydEnabled:                 cfg.Cyd.Enabled,
		NotificationEnabled: cfg.Cyd.Enabled || cfg.Notifications.Ntfy.Enabled || cfg.Notifications.Pushover.Enabled ||
			(cfg.Telegram.BotToken != "" && cfg.Telegram.UserID != 0) || cfg.Discord.Enabled || cfg.Telnyx.Enabled,
...
func buildPromptContextFlags(runCfg RunConfig, policy ToolingPolicy, opts promptContextOptions) prompts.ContextFlags {
	...
	return prompts.ContextFlags{
		...
		NetworkSharesEnabled:     flags.NetworkSharesEnabled,
		...
		HereNowEnabled:           flags.HereNowEnabled,
