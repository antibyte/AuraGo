...
type ToolCall struct {
	...
	MaxTokens        int    `json:"max_tokens,omitempty"`        // approximate token budget for sampled file output
	SamplingStrategy string `json:"sampling_strategy,omitempty"` // head, tail, distributed, semantic
