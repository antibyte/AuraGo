...
var toolCategoryDef = map[string][]ToolCategoryEntry{
	"system": {
		...
		{"list_agent_skills", "List enabled Agent Skills packages"},
		{"activate_agent_skill", "Load SKILL.md instructions for an Agent Skill"},
		{"run_agent_skill_script", "Run an approved Python script from an Agent Skill"},
		{"game_maker_project", "Inspect the isolated Game Maker project manifest, state, and file tree"},
		{"game_maker_file", "Read or atomically update files in the current Game Maker staging area"},
		{"game_maker_asset", "Generate project-bound image or music assets with procedural fallbacks"},
		{"game_maker_validate", "Build and validate the current Game Maker staging area"},
	...
	"network": {
		...
		{"evomap", "Fetch EvoMap capsules and query the gated KG as untrusted external data"},
		...
		{"browser_automation", "Headless background browser sidecar; not visible in Virtual Computers"},
	...
	"infrastructure": {
		...
		{"homepage_quality", "Run homepage screenshots, audits, JS checks, and lint"},
		...
		{"remote_control_desktop", "Capture and automate remote control desktops"},
		{"invasion_nests", "Manage distributed Invasion nests and eggs"},
		{"invasion_tasks", "Send and inspect distributed Invasion tasks"},
		{"invasion_artifacts", "Read distributed Invasion task artifacts"},
	...
	"communication": {
		...
		{"agentmail_messages", "Read, label, send, reply, and forward AgentMail messages"},
		{"agentmail_threads", "List and read AgentMail threads"},
		{"agentmail_drafts", "Create, update, send, and delete AgentMail drafts"},
