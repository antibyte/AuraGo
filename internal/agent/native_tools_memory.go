		...
		tools = append(tools, tool("explore_kg",
			...
			schema(map[string]interface{}{
				"operation": map[string]interface{}{
					...
					"enum":        []string{"add_node", "add_edge", "delete_node", "delete_edge", "update_node", "update_edge", "merge_nodes", "get_node", "get_neighbors", "subgraph", "search", "graph_health", "optimize", "optimize_graph", "explore", "suggest_relations", "suggest_inferred_relations", "export_jsonld", "explain_edge", "list_conflicts", "resolve_conflict", "supersede_edge", "retract_edge"},
				},
