...
- [x] 03-C-PLAN.md -- Modal Consolidation (CONS-03)
- [x] 03-D-PLAN.md -- Translation Consistency Polish (I18N-04)

---

### Phase 4: Vercel Integration for Web Publishing

**Goal:** AuraGo can create and maintain Vercel-backed homepage projects through the existing web publishing workflow, including deploys, aliases/domains, env vars, Config UI setup, and registry logging.

**Depends on:** Phase 3

**Requirements:** WEB-VERCEL-01, WEB-VERCEL-02, WEB-VERCEL-03, WEB-VERCEL-04, WEB-VERCEL-05

**Success Criteria** (what must be TRUE):
1. AuraGo has a dedicated `vercel` integration with token-based authentication, permission gates, and project/deployment/domain/env operations
2. The `homepage` tool can deploy a workspace project to Vercel with a single `deploy_vercel` operation and return the deployment URL
3. The Config UI exposes a Vercel section with vault-backed token save, connection test, default team/project fields, and translated labels in every existing config language
...
| I18N-03 | Phase 3 |
| I18N-04 | Phase 3 |
| WEB-VERCEL-01 | Phase 4 |
| WEB-VERCEL-02 | Phase 4 |
| WEB-VERCEL-03 | Phase 4 |
| WEB-VERCEL-04 | Phase 4 |
| WEB-VERCEL-05 | Phase 4 |

**Mapped:** 23 requirements
**Unmapped:** 0
