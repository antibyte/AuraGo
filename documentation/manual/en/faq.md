...
Back to [Manual Start Page](../README.md) | [English Overview](README.md)
...
Use the installation flow in [Chapter 2: Installation](02-installation.md) and then follow [Chapter 3: Quick Start](03-quickstart.md).

### Do I need Docker?
No. The core agent runs as a single binary. Docker is recommended for isolation and sidecars (for example Gotenberg). See [Docker Installation Guide](../../docker_installation.md).

### How many tools are currently available?
The current platform documents over 100 built-in tools and several integration-specific capabilities. See [Chapter 6: Tools](06-tools.md).
...
Yes, both client integration and server mode are available. Check [Chapter 8: Integrations](08-integrations.md) and [Chapter 7: Configuration](07-configuration.md).
