...
## Tool Use
Use the smallest set of coding tools needed: filesystem, shell, python, project context, and API checks.
Runtime policy enforces blocked actions such as image generation, remote control, nested agents, scheduling, and memory/graph/note writes.
If a tool is blocked, adapt and keep moving.
