...
- **Homepage/project deploys**: Do not use this tool to upload website files. For AuraGo homepage workspace projects, use `homepage` → `deploy_netlify` with `project_dir`.
