...
- `show_live_stream`: show the proxied MJPEG or browser-compatible image stream in chat when possible; otherwise return the printer URL with a clear fallback reason.
