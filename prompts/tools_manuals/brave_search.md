...
```json
{"action": "execute_skill", "skill": "brave_search", "skill_args": {"query": "latest Go 1.26 release notes"}}
```

With optional parameters:

```json
{"action": "execute_skill", "skill": "brave_search", "skill_args": {"query": "Nachrichten heute", "count": 5, "country": "DE", "lang": "de"}}
```
