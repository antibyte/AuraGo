    ...
    properties: [
      {
        ...
        options: [
          ...
          },
          {
            name: 'Status',
            value: 'status',
            description: 'Check AuraGo connection and n8n capabilities',
          },
          {
            name: 'Tool',
            value: 'tool',
      ...
      try {
        ...
        switch (resource) {
          ...
          case 'mission':
            ...
            break;
          case 'status':
            response = await auragoApiRequest.call(this, 'GET', '/api/n8n/status');
            break;
          default:
...
async function executeChatOperation(this: IExecuteFunctions, index: number, operation: string): Promise<any> {
...
async function executeToolOperation(this: IExecuteFunctions, index: number, operation: string): Promise<any> {
  if (operation === 'list') {
  ...
  try {
    ...
    throw new NodeOperationError(this.getNode(), 'Invalid JSON in Parameters field', { itemIndex: index });
  }
...
async function executeMemoryOperation(this: IExecuteFunctions, index: number, operation: string): Promise<any> {
  if (operation === 'search') {
  ...
  try {
    ...
    throw new NodeOperationError(this.getNode(), 'Invalid JSON in Metadata field', { itemIndex: index });
  }
...
async function executeMissionOperation(this: IExecuteFunctions, index: number, operation: string): Promise<any> {
  ...
  try {
    ...
    throw new NodeOperationError(this.getNode(), 'Invalid JSON in Steps field', { itemIndex: index });
  }
